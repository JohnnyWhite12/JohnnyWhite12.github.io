(function (window) {
  ...
  function init(game) {
    ...
    createCannon("top", 450); // a cannon on the top of the screen, located at x = 450, with a 3 second delay (1000ms)
    createCannon("right", 300, 1000); // a cannon on the right side of the screen, located at y = 400, with a 1 second delay (1000ms)
